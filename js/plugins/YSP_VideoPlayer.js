...
! function(t) {
    ...
    var r = n(37),
        ...
        p = function(t) {
            SceneManager._scene._spriteset.removeVideo(t), t.texture.baseTexture.source.pause(), t.texture.baseTexture.source.removeAttribute('src'), t.texture.baseTexture.source.load()
        },
        l = function(t) {
            var e = x(t);
            p(e), delete i[t]
