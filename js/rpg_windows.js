...
Window_ItemList.prototype.drawItem = function(index) {
    ...
    if (item) {
        ...
        this.drawItemName(item, rect.x, rect.y, rect.width - numberWidth +100);
...
Window_NameEdit.prototype.charWidth = function() {
   ...
   // return this.textWidth(text);
    return this.textWidth(text) * 2; //NLT edit
};

Window_NameEdit.prototype.left = function() {
    var nameCenter = (this.contentsWidth() + this.faceWidth()) / 2;
   // var nameWidth = (this._maxLength + 10) * this.charWidth();
    var nameWidth = (this._maxLength + 1) * this.charWidth();
    //return Math.min(nameCenter - nameWidth / 2, this.contentsWidth() - nameWidth);
	return Math.min(nameCenter - nameWidth / 2, this.contentsWidth() - nameWidth - 15); //NLT edit
};
